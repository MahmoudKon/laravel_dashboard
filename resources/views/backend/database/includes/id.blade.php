<tr data-repeater-item>
    ...
    <td>
        <select name="key" class="form-control">
            ...
            <option value="primary" title="Primary" selected> PRIMARY </option>
    ...
    <td class="text-center">
        <input type="checkbox" class="form-control" name="extra" checked value="AUTO_INCREMENT">
    </td>
    <td>
