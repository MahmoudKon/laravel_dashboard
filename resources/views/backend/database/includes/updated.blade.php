<tr data-repeater-item>
    <td>
        <input type="text" class="form-control" name="name" placeholder="name" value="updated_at">
    </td>
    <td>
    ...
    <td>
        <select name="attribute" class="form-control">
            ...
            <option value="on update CURRENT_TIMESTAMP" selected> on update CURRENT_TIMESTAMP </option>
        </select>
    </td>
