...
<div class="col-md-3">
    ...
    <div class="form-group">
        ...
        <div id="file-preview">
            ...
            <div>
                <img src="{{ isset($row) ? asset($row->data) : 'https://www.lifewire.com/thmb/2KYEaloqH6P4xz3c9Ot2GlPLuds=/1920x1080/smart/filters:no_upscale()/cloud-upload-a30f385a928e44e199a62210d578375a.jpg' }}"
