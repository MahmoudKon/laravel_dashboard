...
class CitySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cities = [
                    [
                        "governorate_id" => self::getGovernorateID('القاهرة', 'Cairo'),
                        ...
                        "governorate_id" => self::getGovernorateID('الجيزة', 'Giza'),
                        ...
                        "governorate_id" => self::getGovernorateID('الأسكندرية', 'Alexandria'),
                        ...
                        "governorate_id" => self::getGovernorateID('الدقهلية', 'Dakahlia'),
                        ...
                        "governorate_id" => self::getGovernorateID('البحر الأحمر', 'Red Sea'),
                        ...
                        "governorate_id" => self::getGovernorateID('البحيرة', 'Beheira'),
                        ...
                        "governorate_id" => self::getGovernorateID('الفيوم', 'Fayoum'),
                        ...
                        "governorate_id" => self::getGovernorateID('الغربية', 'Gharbiya'),
                        ...
                        "governorate_id" => self::getGovernorateID('الإسماعلية', 'Ismailia'),
                        ...
                        "governorate_id" => self::getGovernorateID('المنوفية', 'Menofia'),
                        ...
                        "governorate_id" => self::getGovernorateID('المنيا', 'Minya'),
                        ...
                        "governorate_id" => self::getGovernorateID('القليوبية', 'Qaliubiya'),
                        ...
                        "governorate_id" => self::getGovernorateID('الوادي الجديد', 'New Valley'),
                        ...
                        "governorate_id" => self::getGovernorateID('السويس', 'Suez'),
                        ...
                        "governorate_id" => self::getGovernorateID('اسوان', 'Aswan'),
                        ...
                        "governorate_id" => self::getGovernorateID('اسيوط', 'Assiut'),
                        ...
                        "governorate_id" => self::getGovernorateID('___', '___'),
                        "name" => ["ar" => "بني سويف", "en" => "Bani Sweif"]
                    ], [
                        "governorate_id" => self::getGovernorateID('___', '___'),
                        "name" => ["ar" => "بني سويف الجديدة", "en" => "Beni Suef El Gedida"]
                    ], [
                        "governorate_id" => self::getGovernorateID('بني سويف', 'Beni Suef'),
                        ...
                        "governorate_id" => self::getGovernorateID('بورسعيد', 'Port Said'),
                        ...
                        "governorate_id" => self::getGovernorateID('دمياط', 'Damietta'),
                        ...
                        "governorate_id" => self::getGovernorateID('الشرقية', 'Sharkia'),
                        ...
                        "governorate_id" => self::getGovernorateID('جنوب سيناء', 'South Sinai'),
                        ...
                        "governorate_id" => self::getGovernorateID('كفر الشيخ', 'Kafr Al sheikh'),
                        ...
                        "governorate_id" => self::getGovernorateID('مطروح', 'Matrouh'),
                        ...
                        "governorate_id" => self::getGovernorateID('الأقصر', 'Luxor'),
                        ...
                        "governorate_id" => self::getGovernorateID('قنا', 'Qena'),
                        "name" => ["ar" => "قنا", "en" => "Qena"]
                    ], [
                        "governorate_id" => self::getGovernorateID('قنا', 'Qena'),
                        ...
                        "governorate_id" => self::getGovernorateID('شمال سيناء', 'North Sinai'),
                        ...
                        "governorate_id" => self::getGovernorateID('سوهاج', 'Sohag'),
