...
class ClientDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->with(['department', 'user']);
    }
    ...
    protected function getColumns()
    {
        return [
			...
			Column::make('bio')->title(trans('inputs.bio')),
			Column::make('department_id')->title(trans('menu.department')),
			Column::make('user_id')->title(trans('menu.user')),
