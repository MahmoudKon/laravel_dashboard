...
$(document).ready(function(){
    ...
    **********************************/
    $('.upload-image').change(function() {
        ...
        // reinit the cropper plugin
        $('.main-demo-image').on('load', function () {
            $image.cropper(options);
        });
    });

    $('.main-demo-dataX').change(function (e) {
        $image.cropper("setData", {x: Math.round($(this).val())});
    });

    $('.main-demo-dataY').change(function (e) {
        $image.cropper("setData", {y: Math.round($(this).val())});
    });

    $('.main-demo-dataHeight').change(function (e) {
        $image.cropper("setData", {height: Math.round($(this).val())});
    });

    $('.main-demo-dataWidth').change(function (e) {
        $image.cropper("setData", {width: Math.round($(this).val())});
    });
});
